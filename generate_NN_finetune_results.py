...
# Arguments = NUM_LAST_DAYS, EPOCHS , NEAREST_SENSORS -> model trained
## The file would take the path to the specified model and generate json files of its finetuning results
NUM_LAST_DAYS = None
EPOCHS = None
NUM_NEAREST_SENSORS = None
...
model_save_path = f'/Users/architaggarwal/Documents/Projects/AQI/Air-Quality-Index-Calibration/Air-Quality-Index-Calibration_Validation_Exp_Redo/models/NN/unsupervised_lcs_all_data_{NUM_LAST_DAYS}days_{EPOCHS}epochs_{NUM_NEAREST_SENSORS}_senosrs.h5'
...
for num_train_last_days in range(1, 22):
    ...
    save_results_path = f"logs/leave_one_out_finetune_hcs/finetune_{num_train_last_days}_days/NN_{EPOCHS}epochs_{NUM_LAST_DAYS}days_{NUM_NEAREST_SENSORS}sensors.json"
